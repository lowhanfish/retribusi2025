      ...
      <q-card bordered class="my-card">
         ...
         <q-card-section class="biruSangatmudaGrad">
            ...
            <div class="row">
               ...
               <div class="col-12 col-md-4 padding1-5">
                  <div class="frameChart shadow-5">
                     <div id="barPasar" style="width: 100%; height: 400px"></div>
                  </div>
               </div>
            </div>
         </q-card-section>
...
export default {
   ...
   methods: {
      ...
      barPasar: function () {
         Highcharts.chart("barPasar", {
            chart: {
               type: "bar",
               backgroundColor: "transparent",
            },
            title: {
               text: "Jumlah Pasar Berdasarkan Kecamatan",
               align: "left",
            },
            xAxis: {
               categories: ["Konda", "Mowila", "Landono", "Andoolo"],
            },
            yAxis: {
               min: 0,
               title: {
