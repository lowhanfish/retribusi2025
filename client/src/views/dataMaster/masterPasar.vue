         ...
         <q-card-section class="bg-purple-4 text-white">
            <div class="row">
               <div class="col-12 col-md-6">
                  ...
                  <div class="text-subtitle2">Master Pasar</div>
               </div>
               ...
               <q-card-section class="q-pt-none">
                  ...
                  <div class="row">
                     <div class="col-12 col-md-12 frame_cari frame_cari">
                        ...
                        <q-select v-model="form.kecamatan" :options="$store.state.list_kecamatan"
                           option-value="kecamatan_id" option-label="nama_kecamatan" outlined square :dense="true"
                           class="bg-white margin_btn" @input="awaitFetch" emit-value map-options />
                     </div>
                     <div class="col-12 col-md-12 frame_cari frame_cari">
...
export default {
   ...
   methods: {
      ...
      getView: function () {
         ...
         fetch(this.$store.state.url.URL_DM_PASAR + "view", {
            method: "POST",
            headers: {
      ...
      addData: function (number) {
         fetch(this.$store.state.url.URL_DM_PASAR + "addData", {
            method: "POST",
            headers: {
               "content-type": "application/json",
               authorization: "kikensbatara " + localStorage.token
      ...
      editData: function () {
         fetch(this.$store.state.url.URL_DM_PASAR + "editData", {
            method: "POST",
            headers: {
               "content-type": "application/json",
               authorization: "kikensbatara " + localStorage.token
      ...
      removeData: function (E) {
         fetch(this.$store.state.url.URL_DM_PASAR + "removeData", {
            method: "POST",
            headers: {
               "content-type": "application/json",
               authorization: "kikensbatara " + localStorage.token
      ...
      selectData: function (data) {
         ...
         this.form.nm_kecamatan = data.nm_kecamatan;
