        ...
        <div class="row">
          ...
          <div class="col-12 col-md-4">
            <div class="row">
              ...
              <q-btn glossy class="bg-yellow-9" @click="mdl_add = true, form.jenis = 1, form.parrent = null" dense flat icon="add" style="width:10%">
          ...
          <div v-for="data in list_data" :key="data.id">
            <table width="100%" v-if="!cek_load_data">
              ...
              <tr class="h_table_body">
                <td class="text-center">
                  <q-btn color="purple-9" icon="expand_more" size="sm" @click="showHide('' + data.id + '')"
                    :disabled="checkLength(data.subItem)" />
                </td>
                <td class="text-center">
                ...
                <td class="text-center">
                  <q-btn-group>
                    <q-btn size="sm" glossy color="light-blue-8" icon="add" class="tbl_btn"
                      @click="mdl_add = true, form.jenis = 2, form.parrent = data.id" :disabled="checkType(data.type)">
                      <q-tooltip content-class="bg-light-blue-9" content-style="font-size: 13px">
                        Click untuk menambah data ini
                      </q-tooltip>
                    </q-btn>
                    <q-btn size="sm" glossy color="orange" icon="create" class="tbl_btn"
                      @click="selectData(data), mdl_edit = true">
                      <q-tooltip content-class="bg-orange-9" content-style="font-size: 13px">
                        Click untuk mengubah data ini
                      </q-tooltip>
                    </q-btn>
                    <q-btn size="sm" glossy color="negative" icon="delete_forever" class="tbl_btn"
                      @click="selectData(data), mdl_remove = true" :disabled="!checkLength(data.subItem)">
            ...
            <div :id="'' + data.id + ''" class="hidex">
              <div v-for="data1 in data.subItem" :key="data1.id">
                ...
                <table width="100%" v-if="!cek_load_data">
                  <tr class="h_table_body bg-purple-1">
                    <td width="5%" class="text-center">
                      <q-btn color="purple-8" size="sm" icon="expand_more" @click="showHide('' + data1.id + '')"
                        :disabled="checkLength(data1.subItem)" />
                    </td>
                    ...
                    <td width="15%" class="text-center">
                      <q-btn-group>
                        <q-btn size="sm" glossy color="light-blue-8" icon="add" class="tbl_btn"
                          @click="mdl_add = true, form.jenis = 2, form.parrent = data1.id"
                          :disabled="checkType(data1.type)">
                          <q-tooltip content-class="bg-light-blue-9" content-style="font-size: 13px">
                            Click untuk menambah data ini
                          </q-tooltip>
                        </q-btn>
                        <q-btn size="sm" glossy color="orange" icon="create" class="tbl_btn"
                          @click="selectData(data1), mdl_edit = true">
                          <q-tooltip content-class="bg-orange-9" content-style="font-size: 13px">
                            Click untuk mengubah data ini
                          </q-tooltip>
                        </q-btn>
                        <q-btn size="sm" glossy color="negative" icon="delete_forever" class="tbl_btn"
                          @click="selectData(data1), mdl_remove = true" :disabled="!checkLength(data1.subItem)">
                          <q-tooltip content-class="bg-red" content-style="font-size: 13px">
                            Click untuk menghapus data ini
                          </q-tooltip>
                        </q-btn>
                ...
                <div :id="'' + data1.id + ''" class="hidex">
                  <div v-for="data2 in data1.subItem" :key="data2.id">
                    ...
                    <table width="100%" v-if="!cek_load_data">
                      <tr class="h_table_body bg-purple-2">
                        <td width="5%" class="text-center">
                          <q-btn color="purple-7" icon="expand_more" size="sm" @click="showHide('class' + index + '')"
                            disabled />
                        </td>
                        <td width="10%" class="text-center">
                          <q-icon style="font-size:25px" :name="data.icon" />
                        ...
                        <td width="15%" class="text-center">
                          <q-btn-group>
                            ...
                            <q-btn size="sm" glossy color="orange" icon="create" class="tbl_btn"
                              @click="selectData(data2), mdl_edit = true">
                              <q-tooltip content-class="bg-orange-9" content-style="font-size: 13px">
                                Click untuk mengubah data ini
                              </q-tooltip>
                            </q-btn>
                            <q-btn size="sm" glossy color="negative" icon="delete_forever" class="tbl_btn"
                              @click="selectData(data2), mdl_remove = true">
                              <q-tooltip content-class="bg-red" content-style="font-size: 13px">
                                Click untuk menghapus data ini
                              </q-tooltip>
                            </q-btn>
          ...
          <q-card-section class="q-pt-none">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-12 frame_cari">
                ...
                <q-input v-model="form.urutan" type="number" outlined square :dense="true"
