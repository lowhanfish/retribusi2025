        ...
        <div class="row">
          ...
          <div class="col-12 col-md-4">
            <div class="row">
              ...
              <q-btn glossy class="bg-yellow-9" @click="mdl_add = true, funcAwaitAdd()" dense flat icon="add" style="width:10%">
            ...
            <tr class="h_table_body" v-for="(data, index) in list_data" :key="data.id">
              ...
              <td class="text-center">
                <q-btn-group>
                  ...
                  <q-btn @click="selectData(data), mdl_remove = true" glossy color="negative" icon="delete_forever"
                    class="tbl_btn">
                    ...
                    <template v-for="data in list_menu">
                      <tr :key="data.id" class="h_table_body bg-blue-3" style="color:#737373">
                        ...
                        <td width="40%" class="text-center">
                          <div v-if="!data.type">
                            <input type="checkbox" :id="'vehicle1' + data.urutan + 'satu'" name="vehicle1"
                              v-model="data.readx" style="margin-left:3%; accent-color: #0FA668;">
                            <label :for="'vehicle1' + data.urutan + 'satu'"> Read </label>
                            <input type="checkbox" :id="'vehicle2' + data.urutan + 'satu'" name="vehicle2"
                              v-model="data.addx" style="margin-left:3%; accent-color: #3695E4;">
                            <label :for="'vehicle2' + data.urutan + 'satu'"> Add </label>
                            <input type="checkbox" :id="'vehicle3' + data.urutan + 'satu'" name="vehicle2"
                              v-model="data.updatex" style="margin-left:3%; accent-color: #A67D0F;">
                            <label :for="'vehicle3' + data.urutan + 'satu'"> Edit </label>
                            <input type="checkbox" :id="'vehicle4' + data.urutan + 'satu'" name="vehicle2"
                              v-model="data.deletex" style="margin-left:3%; accent-color: #DB4839;">
                      ...
                      <template v-for="data1 in data.subItem">
                        <tr :key="data1.id" class="h_table_body bg-blue-1">
                          ...
                          <td width="40%" class="text-center">
                            <div v-if="!data1.type">
                              <input type="checkbox" :id="'vehicle1' + data1.urutan + 'dua'" name="vehicle1"
                                v-model="data1.readx" style="margin-left:3%; accent-color: #0FA668;">
                              <label :for="'vehicle1' + data1.urutan + 'dua'"> Read </label>
                              <input type="checkbox" :id="'vehicle2' + data1.urutan + 'dua'" name="vehicle2"
                                v-model="data1.addx" style="margin-left:3%; accent-color: #3695E4;">
                              <label :for="'vehicle2' + data1.urutan + 'dua'"> Add </label>
                              <input type="checkbox" :id="'vehicle3' + data1.urutan + 'dua'" name="vehicle2"
                                v-model="data1.updatex" style="margin-left:3%; accent-color: #A67D0F;">
                              <label :for="'vehicle3' + data1.urutan + 'dua'"> Edit </label>
                              <input type="checkbox" :id="'vehicle4' + data1.urutan + 'dua'" name="vehicle2"
                                v-model="data1.deletex" style="margin-left:3%; accent-color: #DB4839;">
                        ...
                        <template v-for="data2 in data1.subItem">
                          <tr :key="data2.id" class="h_table_body">
                            ...
                            <td width="40%" class="text-center">
                              <div v-if="!data2.type">
                                <input type="checkbox" :id="'vehicle1' + data2.urutan + 'tiga'" name="vehicle1"
                                  v-model="data2.readx" style="margin-left:3%; accent-color: #0FA668;">
                                <label :for="'vehicle1' + data2.urutan + 'tiga'"> Read </label>
                                <input type="checkbox" :id="'vehicle2' + data2.urutan + 'tiga'" name="vehicle2"
                                  v-model="data2.addx" style="margin-left:3%; accent-color: #3695E4;">
                                <label :for="'vehicle2' + data2.urutan + 'tiga'"> Add </label>
                                <input type="checkbox" :id="'vehicle3' + data2.urutan + 'tiga'" name="vehicle2"
                                  v-model="data2.updatex" style="margin-left:3%; accent-color: #A67D0F;">
                                <label :for="'vehicle3' + data2.urutan + 'tiga'"> Edit </label>
                                <input type="checkbox" :id="'vehicle4' + data2.urutan + 'tiga'" name="vehicle2"
                                  v-model="data2.deletex" style="margin-left:3%; accent-color: #DB4839;">
                      ...
                      <td width="40%" class="text-center">
                        <div v-if="!data.type">
                          <input type="checkbox" :id="'vehicle1' + data.urutan + 'satu'" name="vehicle1"
                            v-model="data.readx" style="margin-left:3%; accent-color: #0FA668;">
                          <label :for="'vehicle1' + data.urutan + 'satu'"> Read </label>
                          <input type="checkbox" :id="'vehicle2' + data.urutan + 'satu'" name="vehicle2" v-model="data.addx"
                            style="margin-left:3%; accent-color: #3695E4;">
                          <label :for="'vehicle2' + data.urutan + 'satu'"> Add </label>
                          <input type="checkbox" :id="'vehicle3' + data.urutan + 'satu'" name="vehicle2"
                            v-model="data.updatex" style="margin-left:3%; accent-color: #A67D0F;">
                          <label :for="'vehicle3' + data.urutan + 'satu'"> Edit </label>
  ...
  methods: {
    ...
    editData: function () {
      fetch(this.$store.state.url.URL_DM_KLP_USERS + "editData", {
        ...
        this.getView();
        this.Notify('Sukses Mengubah Data', 'warning', 'check_circle_outline');
      });
    },
