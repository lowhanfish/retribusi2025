         ...
         <q-card-section class="bg-purple-4 text-white">
            <div class="row">
               <div class="col-12 col-md-6">
                  ...
                  <div class="text-subtitle2">Besaran Tarif</div>
               </div>
            ...
            <div class="tbl_responsive">
               ...
               <table width="100%">
                  <tr class="h_table_head bg-purple-2">
                     ...
                     <th width="30%">Perda</th>
                     <th width="20%"></th>
                  </tr>
                  <tr class="h_table_body" v-for="(data, index) in list_data" :key="data.id">
                     <td class="text-center">{{ indexing(index + 1) }}.</td>
                     <td>{{ data.uraian }}</td>
                     <td>{{ formatRupiah(data.tarif) }}</td>
                     <td>{{ data.perda }}</td>
            ...
            <form @submit.prevent="addData()">
               <q-card-section class="q-pt-none">
                  ...
                  <div class="row">
                     ...
                     <div class="col-12 col-md-12 frame_cari frame_cari">
                        <span class="h_lable ">Nama Perda</span>
                        <q-input v-model="form.perda" outlined square :dense="true" class="bg-white margin_btn" />
                     </div>
                     <div class="col-12 col-md-12 frame_cari">
                        <span class="h_lable ">Tarif</span>
                        <q-input type="number" v-model="form.tarif" outlined square :dense="true"
...
export default {
   ...
   methods: {
      ...
      getView: function () {
         ...
         fetch(this.$store.state.url.URL_DM_BESARAN_TARIF + "view", {
            method: "POST",
            headers: {
      ...
      addData: function (number) {
         fetch(this.$store.state.url.URL_DM_BESARAN_TARIF + "addData", {
            method: "POST",
            headers: {
               "content-type": "application/json",
               authorization: "kikensbatara " + localStorage.token
      ...
      editData: function () {
         fetch(this.$store.state.url.URL_DM_BESARAN_TARIF + "editData", {
            method: "POST",
            headers: {
               "content-type": "application/json",
               authorization: "kikensbatara " + localStorage.token
      ...
      removeData: function (E) {
         fetch(this.$store.state.url.URL_DM_BESARAN_TARIF + "removeData", {
            method: "POST",
            headers: {
               "content-type": "application/json",
               authorization: "kikensbatara " + localStorage.token
      ...
      selectData: function (data) {
         ...
         this.form.perda = data.perda;
         this.form.tarif = data.tarif;
      },
      ...
      formatRupiah(number) {
         ...
         if (isNaN(num)) {
            return 'Invalid Amount'; // Handle jika input bukan angka
         }

         // Menggunakan Intl.NumberFormat untuk pemformatan lokal Indonesia (IDR)
