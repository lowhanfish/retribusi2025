         ...
         <q-card-section class="bg-purple-4 text-white">
            <div class="row">
               <div class="col-12 col-md-6">
                  <div class="text-h6 h_titleHead">Registrasi Lapak</div>
               </div>
               ...
               <q-card-section class="q-pt-none">
                  ...
                  <div class="row">
                     ...
                     <div class="col-12 col-md-12 frame_cari frame_cari">
                        ...
                        <q-file v-model="dataku.file" outlined square :dense="true" class="bg-white margin_btn">
...
export default {
   ...
   methods: {
      ...
      getView: function () {
         ...
         fetch(this.$store.state.url.URL_DM_REGISTER_LAPAK + "view", {
            method: "POST",
            headers: {
      ...
      addData: function () {
         ...
         if (this.validUser()) {
            ...
            fetch(this.$store.state.url.URL_DM_REGISTER_LAPAK + 'signup', {
               method: "POST",
               headers: {
                  "content-type": "application/json",
                  authorization: "kikensbatara " + localStorage.token
      ...
      removeData: function (idnya) {
         fetch(this.$store.state.url.URL_DM_REGISTER_LAPAK + "removeData", {
            method: "POST",
            headers: {
               "content-type": "application/json",
               authorization: "kikensbatara " + localStorage.token
      ...
      editDataPassword: function () {
         if (this.dataku.password !== this.dataku.confirmPassword) {
            ...
            this.errorMessage = '';
            fetch(this.$store.state.url.URL_DM_REGISTER_LAPAK + "editDataPass", {
               method: "POST",
               headers: {
                  'content-type': 'application/json',
                  authorization: "kikensbatara " + localStorage.token
