					...
					<div class="col-12 col-sm-6 col-md-4" v-for="data in list_data" :key="data.id">
						<q-card class="my-card" flat bordered>
							<q-img :src="file_path + data.file">
								<q-badge v-if="data.status == 0" color="positive" floating label="Pemda"
									class="q-pa-sm text-uppercase text-weight-bold" />
								<q-badge v-else color="warning" floating label="Kontrak"
									class="q-pa-sm text-uppercase text-weight-bold" />
							</q-img>
					...
					<div>
						...
						<q-list dense bordered separator class="rounded-borders">
							...
							<q-item>
								...
								<q-item-section>
									<q-badge v-if="form.status == 0" color="positive" label="Pemda" style="width: 50px;" />
									<q-badge v-else color="warning" label="Kontrak" style="width: 55px;" />
								</q-item-section>
							</q-item>
							<q-item>
